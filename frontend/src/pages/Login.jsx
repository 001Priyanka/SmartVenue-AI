  ...
  return (
    <div className="auth-container fade-in">
      <div className="auth-header">
        ...
        <h1 className="auth-title">SmartVenue AI</h1>
      ...
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <button type="submit" className="auth-button primary" disabled={isLoading || !email || !password}>
      ...
      <p className="auth-link-text">
        ...
        <span className="auth-link" onClick={onNavigateSignup}>Sign up</span>
      </p>
    </div>
  );
};
